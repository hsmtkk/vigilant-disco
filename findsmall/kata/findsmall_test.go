...
import (
	...
	"github.com/hsmtkk/vigilant-disco/findsmall/kata"
	"github.com/stretchr/testify/assert"
)

func TestSmallest0(t *testing.T) {
	assert.Equal(t, []int64{126235, 2, 0}, kata.Smallest(261235))
}

func TestSmallest1(t *testing.T) {
